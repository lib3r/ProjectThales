...
def insertExchanges(countrycodes, exchangedict):
    ...
    for exchange in exchangedict:
        ...
        print exchangedict[exchange]
        if str(exchangedict[exchange][0]) != exchangedict[exchange][0]:
            exchangedict[exchange][0] = ''
        # Handle NaN values
        ...
        # Skip anything that doesn't have abbreviation
        if flag%2 == 1:
            continue
